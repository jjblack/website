...
*/
   ...
   function init() {
      ...
      log("Website", "A!");
      log("Website", "Welcome to '[^http://jakeblack.me](*JakeBlack.me*)'");
      log("Website", "");
      log("Website", "I am a Network and Linux System Administrator, currently studying at Michigan Technological University.");
      log("Website", "");
      log("Website", "");
	  urlvars();
      ...
      switch (word[0]) {
         ...
         case "/nav":
            if ($.inArray(word[1], pageindex) >= 0) {
               currentpage = word[1];
               log("Website", "You are now on page: " + currentpage);
